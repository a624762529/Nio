...
public:
    ...
    void  setReadArg(void *arg);
    void* getReadArg();

    void  setWriteArg(void *arg);
    void* getWriteArg();

    void  setExpArg(void *arg);
    char* getWriteBuf();
public:
...
public:
    ...
    void writeQString(QString info);
    void appendQString(QString info);
private:
    int  readHeadLen();
    bool isReadOver();
    void doReadOver();
